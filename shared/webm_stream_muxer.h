...
#ifndef SHARED_WEBM_STREAM_MUXER_H_
#define SHARED_WEBM_STREAM_MUXER_H_
...
// Forward declarations of libwebm muxer types used by |WebMStreamMuxer|.
namespace mkvmuxer {
class Segment;
}
...
class WebMStreamMuxer {
 public:
  ...
  // successful.
  int Init(uint64 maxClusterDuration);
 ...
 private:
  ...
  bool initialized_;
  WEBM_TOOLS_DISALLOW_COPY_AND_ASSIGN(WebMStreamMuxer);
};

}  // namespace webm_tools

#endif  // SHARED_WEBM_STREAM_MUXER_H_
